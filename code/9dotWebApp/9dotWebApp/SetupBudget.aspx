<%@ Page Title="" Language="C#" MasterPageFile="~/9dot.Master" AutoEventWireup="true" CodeBehind="SetupBudget.aspx.cs" Inherits="_9dotWebApp.WebForm2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style1" style="font-family: Calibri">
        <tr>
            <td class="auto-style2"><strong>Gross Revenue</strong></td>
    ...
    <table class="auto-style1" style="font-family: Calibri">
        <tr>
            <td class="auto-style2"><strong>Direct Costs / COGS</strong></td>
    ...
    <table class="auto-style1" style="font-family: Calibri">
        <tr>
            <td class="auto-style2"><strong>OPEX</strong></td>
            <td class="auto-style2">
    ...
    <table class="auto-style1" style="font-family: Calibri">
        <tr>
            <td class="auto-style2">Depreciation</td>
            <td class="auto-style2">
